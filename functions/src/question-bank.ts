...
// This contains a large pool of questions that can be rotated daily
...
export const questionBank: Question[] = [
  ...
  },
  {
    ...
    options: ["Nancy Pelosi", "Kevin McCarthy", "Mike Johnson", "Chuck Schumer"],
    correctAnswerIndex: 2,
    category: "Government"
  },
  {
    questionText: "Who does a U.S. Senator represent?",
    options: ["All people of the state", "Only the capital city", "Only their political party", "The President"],
    correctAnswerIndex: 0,
    category: "Government"
  },
  {
    questionText: "Why do some states have more Representatives than other states?",
    options: ["They are larger", "They have more people", "They were founded earlier", "They have more money"],
    correctAnswerIndex: 1,
    category: "Government"
  },
  {
